...
export const PizzaImg = (props:PizzaImgProps,)=> {
    ...
    return(
        ...
        <div className={`${Style.Big} w-[450px] h-[450px] relative rounded-[50%] flex items-center justify-center border border-dashed border-gray-dotted`}>
           
            <div className={`${Style.Middle} w-[375px] h-[375px] rounded-[50%] flex items-center justify-center border border-dashed border-gray-dotted`}>
                <div  className={`${Style.Little} w-[300px] h-[300px] rounded-[50%]`}>
